...
public class Beton extends AbstractMaterials{
    ...
    public Beton(String materialsBrand,String materialsColor,double priceInUAH,double materialSize,String companyOfManufactures,boolean neededForSockets,String betonBrend){
